...
for (const needle of ["styles.css?v=15", "app.js?v=15", "manifest.webmanifest?v=15"]) {
  if (!html.includes(needle)) throw new Error(`index.html referenziert ${needle} nicht.`);
}

if (!worker.includes("galactic-forum-v15")) {
  throw new Error("Service Worker Cache-Version ist nicht v15.");
}

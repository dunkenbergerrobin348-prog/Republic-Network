...
for (const needle of ["styles.css?v=14", "app.js?v=14", "manifest.webmanifest?v=14"]) {
  if (!html.includes(needle)) throw new Error(`index.html referenziert ${needle} nicht.`);
}

if (!worker.includes("galactic-forum-v14")) {
  throw new Error("Service Worker Cache-Version ist nicht v14.");
}
